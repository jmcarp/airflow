...
class TestConf(unittest.TestCase):
    ...
    def test_airflow_config_default(self):
        with unittest.mock.patch.dict('os.environ'):
            ...
            assert get_airflow_config('/home/airflow') == \
    ...
    def test_conf_as_dict(self):
        ...
        assert cfg_dict['kubernetes_environment_variables']['AIRFLOW__TESTSECTION__TESTKEY'] == \
            '< hidden >'
...
'''
        ...
        assert True == test_conf.getboolean('another', 'key8_boolean', fallback='True')
...
"""
        ...
        assert True == test_conf.getboolean('true', 'key2')
        assert True == test_conf.getboolean('true', 'key3')
        assert True == test_conf.getboolean('true', 'key4')
        assert False == test_conf.getboolean('false', 'key5')
        assert False == test_conf.getboolean('false', 'key6')
        assert False == test_conf.getboolean('false', 'key7')
        assert True == test_conf.getboolean('inline-comment', 'key8')
...
'''
    ...
    def test_get_section_should_respect_cmd_env_variable(self):
        ...
        assert content["git_password"] == "difficult_unpredictable_cat_password"
...
'''
        ...
        assert OrderedDict([('key1', 'hello'), ('AIRFLOW_HOME', '/root/airflow')]) == \
    ...
    def test_deprecated_values(self):
        ...
        with pytest.warns(FutureWarning):
            ...
            assert test_conf.get('core', 'task_runner') == 'StandardTaskRunner'
        ...
        with reset_warning_registry():
            with warnings.catch_warnings(record=True) as warning:
                with unittest.mock.patch.dict('os.environ', AIRFLOW__CORE__TASK_RUNNER='NotBashTaskRunner'):
                    ...
                    assert test_conf.get('core', 'task_runner') == 'NotBashTaskRunner'
...
'''
    ...
    def test_config_throw_error_when_original_and_fallback_is_absent(self):
        ...
        with conf_vars({('core', 'fernet_key'): None}):
            with pytest.raises(AirflowConfigException) as cm:
    ...
    def test_run_command(self):
        ...
        assert run_command("python -c '{0}'".format(cmd)) == '\u1000foo'
