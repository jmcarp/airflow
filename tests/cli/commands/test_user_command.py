...
class TestCliUsers(unittest.TestCase):
    ...
    def test_cli_list_users(self):
        ...
        for i in range(0, 3):
            assert 'user{}'.format(i) in stdout
    ...
    def test_cli_add_user_role(self):
        ...
        assert not _does_user_belong_to_role(appbuilder=self.appbuilder, email=TEST_USER1_EMAIL, rolename='Op'), \
    ...
    def test_cli_remove_user_role(self):
        ...
        assert _does_user_belong_to_role(appbuilder=self.appbuilder, email=TEST_USER1_EMAIL, rolename='Viewer'), \
        ...
        assert not _does_user_belong_to_role(appbuilder=self.appbuilder, email=TEST_USER1_EMAIL, rolename='Viewer'), \
