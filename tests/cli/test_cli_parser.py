...
def test_arg_option_long_only(self):
    ...
    for group, command in subcommand.items():
        for com in command:
            ...
            assert [] == conflict_arg,            f"Command group {group} function {com.name} have "            f"conflict args name {conflict_arg}"
    ...
    for group, command in subcommand.items():
        for com in command:
            ...
            assert [] == conflict_position,            f"Command group {group} function {com.name} have conflict "            f"position flags {conflict_position}"
            ...
            assert [] == conflict_long_option,            f"Command group {group} function {com.name} have conflict "            f"long option flags {conflict_long_option}"
            ...
            assert [] == conflict_short_option,            f"Command group {group} function {com.name} have conflict "            f"short option flags {conflict_short_option}"
