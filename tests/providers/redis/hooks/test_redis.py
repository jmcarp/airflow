...
class TestRedisHook(unittest.TestCase):
    def test_get_conn(self):
        ...
        assert hook.redis == None

        assert hook.host == None, 'host initialised as None.'
        assert hook.port == None, 'port initialised as None.'
        assert hook.password == None, 'password initialised as None.'
        assert hook.db == None, 'db initialised as None.'
