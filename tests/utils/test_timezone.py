...
class TestTimezone(unittest.TestCase):
    ...
    def test_make_naive(self):
        assert timezone.make_naive(datetime.datetime(2011, 9, 1, 13, 20, 30, tzinfo=EAT), EAT) == \
            datetime.datetime(2011, 9, 1, 13, 20, 30)
        assert timezone.make_naive(datetime.datetime(2011, 9, 1, 17, 20, 30, tzinfo=ICT), EAT) == \
            datetime.datetime(2011, 9, 1, 13, 20, 30)
    ...
    def test_make_aware(self):
        assert timezone.make_aware(datetime.datetime(2011, 9, 1, 13, 20, 30), EAT) == \
